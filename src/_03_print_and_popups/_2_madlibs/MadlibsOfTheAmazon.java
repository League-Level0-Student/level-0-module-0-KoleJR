...
public class MadlibsOfTheAmazon {
	...
	public static void main(String[] args) {
		...
		String adjective = JOptionPane.showInputDialog("!ENTER ADJECTIVE NOW!");

		// Get the player to enter a type of liquid
		String liquid = JOptionPane.showInputDialog("Enter a liquid or your bad");
		// Get the player to enter a body part
		String bodypart = JOptionPane.showInputDialog("Enter a body part :l");
		// Get the player to enter a verb
		String verb = JOptionPane.showInputDialog("Enter a verb sir");
		// Get the player to enter a place
		String place = JOptionPane.showInputDialog("eNTer A PLAcE noW");
